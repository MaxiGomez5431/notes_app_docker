    ...
    <NavLink
      ...
      className={({ isActive }) =>
        ...
        ${isActive 
          ...
          : 'border-gray-300 text-text-color shadow-custom-size active:translate-y-0.5 shadow-gray-300 hover:bg-brand-orange/20 hover:border-brand-orange hover:text-brand-orange'
        }`
      }
    >
      {children}
